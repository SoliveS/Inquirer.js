...
Prompt.prototype._run = function (cb) {
  ...
  this.pubsub.on('interrupt-prompt', this.onInterrupt);
 ...
 */
 ...
 Prompt.prototype.onInterrupt = function () {
   this.pubsub.removeListener('interrupt-prompt', this.onInterrupt);
   ...
   this.screen.done();
   cliCursor.show();
   // don't execute callback when interrupted
 }
