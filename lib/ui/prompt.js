...
var PromptUI = module.exports = function (prompts, opt, pubsub) {
  Base.call(this, opt);
...
PromptUI.prototype.run = function (questions) {
  ...
  return this.process
    ...
    // catch rejected promise, so undefined will be returned
    .catch(this.onCompletion.bind(this));
};
