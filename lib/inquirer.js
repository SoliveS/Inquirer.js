...
inquirer.pubsub = new EventEmitter();

inquirer.interruptPrompt = function() { inquirer.pubsub.emit('interrupt-prompt'); };
...
inquirer.createPromptModule = function (opt) {
  var promptModule = function (questions) {
    var ui = new inquirer.ui.Prompt(promptModule.prompts, opt, inquirer.pubsub);
